            ...
            function searchTrain(){
                if($(".searchTrainBtn").attr("state") == "oneWay"){
                    ...
                    var searchTrainInfo = {
                        ...
                        'queryKey':$('#trainDepartureCity').attr('cn')+','+$('#trainArrivalCity').attr('cn')+','+$('#trainDepartureDate').val()+',',
                    ...
                    var searchTrainInfo = {
                        ...
                        'queryKey':$('#trainDepartureCity').attr('cn')+','+$('#trainArrivalCity').attr('cn')+','+$('#trainDepartureDate').val()+',',
                        'queryKeyReturn':$('#trainArrivalCity').attr('cn')+','+$('#trainDepartureCity').attr('cn')+','+$('#trainReturnDate').val()+',',
						'domqueryKey':$('#trainDepartureCity').attr('code') + ',' + $('#trainArrivalCity').attr('code') + ',' + $('#trainDepartureDate').val() + DepartureSelectValue+',' + $("#trainCabin").val()+ ',ALL',
...
function setCity(){
	...
	if(cityObj.type){
		...
		$('#trainDepartureCity').attr('cn',cityObj.ArriveCityCN)
		...
		$('#trainArrivalCity').attr('cn',cityObj.leaveCityCN)
