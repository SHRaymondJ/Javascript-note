...
function chooseHotel(){
    ...
    $(".searchHotelBtn").unbind("click").click(function(){
        ...
        if(hotelCityCode){
            ...
            var queryKey = hotelCityCode+','+hotelAreaTypeID+','+hotelname+','+address+','+$("#hotelDepartureDate").val()+','+$("#hotelReturnDate").val()+','+stars+','+$("#hotelPrice").attr("minPrice")+','+$("#hotelPrice").attr("maxPrice")+",1,1,1,2000,"+hotel_lonLat+",";
            var searchHotelInfo = {
                'queryKey':queryKey,
