            ...
            <div class="passengerInfo">\
                ...
                <div class="passengerBody">\
                  ...
                  <div class="passengerBar">\
                    ...
                    <div class="passengerBarLi passengerBarLi-document" style="width:240px;">\
                        <span class="documentTitle">'+ get_lan('passengerPop').popDocuments + '</span>\
                        <div class="documentRemind">\
                            <div class="documentRemind__text">'+ get_lan('documentRemind') + '</div>\
                            <img src="./images/icon_help.png"/>\
                        </div>\
                    </div>\
                    <div class="passengerBarLi train12306" style="width:240px;">'+ get_lan('passengerPop').train12306account + '</div>\
                  </div>\
            ...
            res.map(function (item) {
                ...
                $(".orderDetail").append('\
	                <div class="orderDetailBody" trainCode="'+ item.TrainCode + '" ticketAmount="' + (parseFloat(item.FareList[0].Price) + parseFloat(item.FareList[0].ServiceFare)) + '">\
	                  ...
	                  <div class="orderFareAmount flexRow"><div>'+ get_lan('orderDetail').ticketPrice + '</div><span style="font-size:20px;">' + item.FareList[0].Price + ProfileInfo.OfficeCurrency + '</span></div>\
	                  <div class="orderServiceFare flexRow '+ showServiceFare + '"><div>' + get_lan('orderDetail').serviceFare + '</div><span class="activeFontColor">' + item.FareList[0].ServiceFare + ProfileInfo.OfficeCurrency + '</span></div>\
                                            ...
                                            if (res.Message) {
                                                ...
                                                if (searchTrainInfo.alterTicketInfo) {
                                                    ...
                                                    res.Customers.map(function (item, index) {
                                                        ...
                                                        //     <div class="passengerLi" customerId="'+item.CustomerID+'">
                                                        ...
                                                        $(".passengerList").append('\
                                                <div class="passengerLi" Birthday="'+ item.Birthday + '" Gender="' + Gender + '" Nationality="' + Nationality + '" customerId="' + item.CustomerID + '" companyId="' + CompanyId + '">\
                                                    ...
                                                    <div class="passengerLiDiv passengerLiDocuments" style="width:220px;margin-right:22px;"><select class="documentsSelect"></select></div>\
                                                    <div class="passengerLiDiv frequentCardsText" style="width:240px;text-align:left;"></div>\
                                                </div>\
                                                \
                                                ')
                                                        var checkedID = ''
                                                ...
                                                ')
                                                        ...
                                                        var id = item.ID ? item.ID : item.CustomerID;

                                                        var train12306display = use12306DisplayEffect(ProfileInfo)
                                                        if ( train12306display.train12306 ) {
                                                            initEmployee12306(id, item['Name' + obtLanguage], item.ChinaRailwayAccountName, item.ChinaRailwayAccountPwd);
                                                        } 
    ...
    $.ajax(
        {
            ...
            success: function (data) {
                ...
                res.map(function (item, index) {
                    ...
                    var CompanyId = item.OrderCompanyId ? item.OrderCompanyId : ""
                    $(".passengerList").append('\
                    <div class="passengerLi" Birthday="'+ item.Birthday + '" Gender="' + Gender + '" Nationality="' + Nationality + '" customerId="' + item.ID + '" companyId="' + CompanyId + '">\
                    ...
                    <div class="passengerLiDiv changeRemarkBtn specificFontColor" index="'+ index + '"  style="width:100px;text-decoration: underline;cursor:pointer">' + get_lan('passengerInfo').remarks + '</div>\
