    ...
    KuCity.prototype = {
        ...
        inputSearch: function () {
            ...
            function search(e) {
                ...
                $('.kucity').css('top', ($(self.target).offset().top - $('.kucity').height()-20) + 'px')
            }
        },
        //列表，结果，整体 显示切换
        triggleShow: function (open) {
            ...
            if (($('.kucity').offset().top + $('.kucity').height()) > window.innerHeight) {
                $('.kucity').css('top', ($('.kucity').offset().top - $('.kucity').height() - 55) + 'px')
            }
