    ...
    $("#main").html('\
        <div class="autoCenter">\
            ...
            <div class="remindInfo">\
              ...
              + POReminder +
              '<span class="intlNotice2 mainFontColor">'+ get_lan("intlNotice2") + '</span><br>\
              <span class="covidReminder"></span><br><br>\
            </div>\
                                    ...
                                    if (res.Message) {
                                        ...
                                        res.Customers.map(function (item, index) {
                                            ...
                                            $(".passengerList").append('\
                                                ...
                                                <div class="passengerLiDiv" style="width:250px;"><span class="PassengerNameText">'+ item.NameEN + '</span><span class="changePassengerInfo" index="' + index + '" customerId="' + item.CustomerID + '" style="margin-left:5px;cursor:pointer;">' + changePassengerInfo + '</span></div>\
